...
from attribute_based import Class
from attribute_based import Instance
from attribute_based import OBJECT
from attribute_based import TYPE

class TestAttributeBased(unittest.TestCase):
