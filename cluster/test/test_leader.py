...
Commander = mock.Mock(spec_set=Commander)
Scout = mock.Mock(spec_set=Scout)

class TestLeader(utils.ComponentTestCase):
    def setUp(self):
        super().setUp()
        Scout.reset_mock()
    ...
    def test_commander_finished_preemted(self):
        self.activate_leader()
        self.node.fake_message(Propose(slot=10, proposal=PROPOSAL1))
    ...
    def test_scout_finished_adopted(self):
        ...
        self.assertEqual(self.ldr.proposals, {9: PROPOSAL2, 10: PROPOSAL3})
