...
class TestWithStatement(vmtest.VmTestCase):
    ...
    def test_at_context_manager_simplified(self):
        self.assert_ok('''
            ...
            class GeneretorContextManager(object):
                ...
                def __enter__(self):
                    try:
                        ...
                        return RuntimeError('generator didn\\'t yield')
                ...
                def __exit__(self, type, value, traceback):
                    if type is None:
                        try:
                            ...
                            raise RumtimeError('generator didn\\'t stop')
                    else:
                        if value is None:
                            value = type()
                        try:
            ...
            def contextmanager(func):
                def helper(*args, **kwargs):
                    return GeneretorContextManager(func(*args, **kwargs))
