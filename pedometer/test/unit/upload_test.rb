...
class UploadTest < Test::Unit::TestCase
  ...
  def test_create
    temp_file = 'data/upload-1.txt'
    file_path = 'uploads/female-999.0-90.0_run1-89-10.txt'
  ...
  def test_find
    file_path = 'uploads/female-168.0-70.0_walk1-100-100.txt'
  ...
  def test_generate_file_path
    file_path = 'uploads/female-999.0-90.0_bagwalk1-89-10.txt'
