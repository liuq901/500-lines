...
public class ImageState
{
    ...
    public void updateImage(PApplet applet, int hueRange, int rgbColorRange, int imageMax)
    {
        ...
        colorHelper.applyColorFilter(applet, image, redFilter, greenFilter, blueFilter, rgbColorRange);
        image.updatePixels();
    }
    ...
    protected void set(IFAImage image, ColorMode colorModeState, int redFilter, int greenFilter, int blueFilter, int hueTolerance)
    {
        this.image = image;
